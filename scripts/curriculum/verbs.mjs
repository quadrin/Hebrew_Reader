...
export const WEAK_ROOTS = [
  ...
  },
  {
    id: "pe-yod",
    he: "פ״י",
    en: "roots beginning with י",
    why: "The initial י will not stand at the head of a syllable in the future, so it drops and the prefix vowel lengthens to cover the gap.",
    verb: { root: "י־ש־ב", inf: "לָשֶׁבֶת", en: "to sit, to live somewhere" },
    forms: [
      { label: "he sits", he: "יוֹשֵׁב", note: "present keeps the yod" },
      { label: "he sat", he: "יָשַׁב", note: "so does the past" },
      { label: "he will sit", he: "יֵשֵׁב", note: "the root yod is gone; the prefix carries a tsere" },
      { label: "to sit", he: "לָשֶׁבֶת", note: "an infinitive with no yod in it at all" },
      { label: "sit! (m.)", he: "שֵׁב", note: "" },
    ],
  },
  {
    id: "lamed-alef",
    he: "ל״א",
    en: "roots ending in א",
    why: "The final א stopped being pronounced, so the vowel before it stretches and the endings attach as though it were not there.",
    verb: { root: "מ־צ־א", inf: "לִמְצֹא", en: "to find" },
    forms: [
      { label: "he finds", he: "מוֹצֵא", note: "" },
      { label: "she finds", he: "מוֹצֵאת", note: "not מוֹצֵאָה" },
      { label: "he found", he: "מָצָא", note: "" },
      { label: "I found", he: "מָצָאתִי", note: "the א is written and never heard" },
      { label: "he will find", he: "יִמְצָא", note: "a patach, where the strong verb has a cholam" },
      { label: "to find", he: "לִמְצֹא", note: "" },
    ],
  },
  {
    id: "lamed-guttural",
    he: "ל״ג",
    en: "roots ending in ע or ח",
    why: "A final ע or ח cannot close a syllable on any vowel but a, so an extra a-sound slides in underneath it — the furtive patach.",
    verb: { root: "ש־מ־ע", inf: "לִשְׁמֹעַ", en: "to hear" },
    forms: [
      { label: "he hears", he: "שׁוֹמֵעַ", note: "the patach is heard before the ע, not after" },
      { label: "she hears", he: "שׁוֹמַעַת", note: "" },
      { label: "he heard", he: "שָׁמַע", note: "" },
      { label: "he will hear", he: "יִשְׁמַע", note: "patach again, where כתב takes a cholam" },
      { label: "to hear", he: "לִשְׁמֹעַ", note: "" },
      { label: "hear! (m.)", he: "שְׁמַע", note: "" },
    ],
  },
  {
    id: "lamed-he",
