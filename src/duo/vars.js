/* The reader's theme, translated into the path's variables.
   ...
   The lesson player is not the only screen wearing this skin: the cloze
   practice is a lesson too, and it is rendered from App.jsx, so the
   translation lives here rather than inside either of them. */
